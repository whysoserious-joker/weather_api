...
w.name,
w.country_code ,
round(avg(CASE WHEN w.wind_direction_angle <> 999 THEN  w.wind_direction_angle END ),2) as wind_direction_angle,
...
where w.station_id=%s AND date(date) between %s and %s
